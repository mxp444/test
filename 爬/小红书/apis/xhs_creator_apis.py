...
def read_sample_media(*parts):
    return (PROJECT_DIR / "samples" / Path(*parts)).read_bytes()
    ...
    noteInfos = [
        {
            ...
            # 图片路径 最多15张
            "images": [
                read_sample_media("images", "sample.jpg"),
            ],
        },
        {
            "title": "test2",
            ...
            "type": 1,
            "media_type": "video",
            "video": read_sample_media("videos", "sample.mp4"),
        }
    ]
