...
def compile_static_js(file_name):
    return execjs.compile((PROJECT_DIR / "static" / file_name).read_text(encoding="utf-8"))


js = compile_static_js("xhs_creator_260411.js")
signature_js = compile_static_js("xhs_creator_signature.js")
sign_js = compile_static_js("xhs_creator_sign.js")
